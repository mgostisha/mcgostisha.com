...
export default function Index() {
  return (
    <div className="index grid">
      ...
      <p>I lead the <Outline>web product team</Outline> for <Link external to="https://info.flip.com">Flip</Link> at <Link external to="https://careers.microsoft.com/us/en/search-results?keywords=Flipgrid">Microsoft</Link>.</p>
